              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link href="/dashboard/events/new">
                    <Button className="rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 shadow-lg shadow-purple-500/20">
            ...
            {events.length === 0 ? (
              <Card className="border-2 border-dashed border-muted-foreground/20 rounded-xl">
                <CardContent className="flex flex-col items-center justify-center py-20 px-6 text-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-purple-500/15 to-blue-500/15 flex items-center justify-center mb-6">
