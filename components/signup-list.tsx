  ...
  const handleRemove = async (signupId: string) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          error instanceof Error ? error.message : "Failed to remove signup",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="space-y-3">
        {signups.map((signup) => {
          const slot = slots.find(
            (s) => s.id === ((signup as any).slot_id || signup.slotId)
          );
        ...
        <DialogContent className="max-w-[calc(100vw-2rem)] sm:max-w-lg mx-4">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm sm:text-base">
              Are you sure you want to remove this signup? This action cannot be
              undone.
            </DialogDescription>
          </DialogHeader>
