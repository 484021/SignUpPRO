...
export default function LandingPage() {
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white via-slate-100 to-white text-slate-900 dark:from-purple-950/20 dark:via-blue-950/20 dark:to-cyan-950/20 dark:text-white">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-3">
            <FontAwesomeIcon icon={faSpinner} className="w-8 h-8 animate-spin text-blue-600 dark:text-purple-600 mx-auto" />
  ...
  return (
    <div className={theme === "dark" ? "dark" : ""}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Signups,
                <span className="block text-[min(13vw,68px)] leading-tight bg-[linear-gradient(120deg,#0f172a,#2563eb,#1e293b)] dark:bg-[linear-gradient(120deg,#e8ecf3,#6ab8ff,#9cc7ff)] bg-clip-text text-transparent">
                  re-engineered.
                </span>
              </motion.h1>
              <motion.p
                className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-white/70 max-w-2xl"
                variants={{
              ...
              >
                Create and share clean sign-up lists in seconds — without the chaos of group chats. Built for organizers who value precision, speed, and calm.
              </motion.p>
            </motion.div>
            <motion.div
            ...
            >
              <Link href="/sign-in">
                <Button
                  size="lg"
                  className="h-12 sm:h-14 px-6 sm:px-8 rounded-full bg-black text-white font-semibold hover:bg-black/90 shadow-[0_10px_50px_-20px_rgba(0,0,0,0.4)] dark:bg-white dark:text-black dark:hover:bg-white/90 dark:shadow-[0_10px_50px_-20px_rgba(255,255,255,0.6)]"
                >
                  Create Signup
              ...
              <Link href="#how-it-works">
                ...
                >
                  See how it works
                  <FontAwesomeIcon icon={faCirclePlay} className="w-4 h-4 ml-2" />
                </Button>
              </Link>
            </motion.div>
            <motion.div
              className="flex flex-wrap items-center gap-4 text-sm text-slate-600 dark:text-white/70"
              variants={{
            ...
            >
              <span className="inline-flex items-center gap-2">
                <FontAwesomeIcon icon={faUsers} className="w-4 h-4 text-blue-500 dark:text-blue-300" />
                Trusted by sports clubs, classes, and community organizers
              </span>
              <span className="inline-flex items-center gap-2">
                <FontAwesomeIcon icon={faCircleCheck} className="w-4 h-4 text-blue-500 dark:text-blue-300" />
                3,000+ signups managed
              </span>
              <span className="inline-flex items-center gap-2">
                <FontAwesomeIcon icon={faShieldHalved} className="w-4 h-4 text-blue-500 dark:text-blue-300" />
                99.9% uptime
              </span>
            </motion.div>
          </motion.div>
              ...
              <div className="p-6 sm:p-8 space-y-6">
                <div className="flex items-center justify-between text-sm text-slate-600 dark:text-white/70">
                  ...
                  <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-xs text-slate-700 dark:bg-white/10 dark:border-white/10 dark:text-white/80">
                    <FontAwesomeIcon icon={faBolt} className="w-3 h-3 text-blue-500 dark:text-blue-300" />
                    Under 10s setup
                  </span>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-4 space-y-4 shadow-inner dark:border-white/10 dark:bg-black/40">
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-[0.2em] text-slate-500 dark:text-white/50">Event name</label>
                    <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-slate-900 flex items-center gap-3 dark:border-white/15 dark:bg-white/5 dark:text-white/90">
                      ...
                      <span className="font-semibold">Saturday Badminton Ladder</span>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-3 dark:border-white/10 dark:bg-white/5">
                    ...
                    <Button className="w-full rounded-xl bg-black text-white hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90">
                      Share signup link
                      <FontAwesomeIcon icon={faLink} className="w-4 h-4 ml-2" />
                    </Button>
                  </div>
                </div>
              </div>
      ...
      {/* How it works */}
      <section id="how-it-works" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#f4f6fb] via-white to-white dark:from-[#0b0f14] dark:via-black dark:to-black">
        <div className="container mx-auto max-w-5xl space-y-12">
          <div className="space-y-3 text-center">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-white/50">How it works</p>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 dark:text-white">Create a signup in under 10 seconds</h2>
            <p className="text-slate-600 dark:text-white/60 text-lg max-w-2xl mx-auto">
              Speed, simplicity, reliability — nothing else. Organizers stay focused, attendees sign up instantly.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative space-y-4">
                  ...
                  <div className="text-sm text-slate-500 dark:text-white/50">Step {idx + 1}</div>
                  <h3 className="text-xl font-semibold text-slate-900 dark:text-white">{item.title}</h3>
                  <p className="text-slate-600 dark:text-white/70 leading-relaxed">{item.body}</p>
                </div>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#05070b]">
        <div className="container mx-auto max-w-6xl grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-white/50">For organizers</p>
            <h3 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white">Precision over clutter.</h3>
            <p className="text-slate-600 dark:text-white/65 text-lg">
              Build the exact list you need. Lock duplicates, control time zones, and keep every slot intentional.
            </p>
            <div className="space-y-4">
              {[
                ...
                <div key={point} className="flex items-start gap-3 text-slate-700 dark:text-white/75">
                  <FontAwesomeIcon icon={faCircleCheck} className="mt-1 w-4 h-4 text-blue-500 dark:text-blue-300" />
                  <span>{point}</span>
                </div>
              ))}
            </div>
            <div className="flex flex-wrap gap-3 text-sm text-slate-600 dark:text-white/60">
              <span className="rounded-full border border-slate-200 px-4 py-2 bg-slate-50 dark:border-white/10 dark:bg-white/5">Magic link + Google</span>
              <span className="rounded-full border border-slate-200 px-4 py-2 bg-slate-50 dark:border-white/10 dark:bg-white/5">CSV export</span>
              <span className="rounded-full border border-slate-200 px-4 py-2 bg-slate-50 dark:border-white/10 dark:bg-white/5">Auto waitlist</span>
            </div>
          </div>

          <div className="space-y-6">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-white/50">For attendees</p>
            <h3 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white">Zero friction signups.</h3>
            <p className="text-slate-600 dark:text-white/65 text-lg">
              No accounts, no clutter. A single, beautiful page that makes committing effortless.
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { label: "One link", desc: "Sign up from chat, email, or QR." },
                { label: "Instant status", desc: "See availability in real time." },
                { label: "Smart updates", desc: "Auto confirms and reminders." },
                { label: "Works everywhere", desc: "Mobile-first, desktop-perfect." },
              ].map((item) => (
                <Card key={item.label} className="rounded-xl border-slate-200 bg-white p-4 dark:border-white/10 dark:bg-white/5">
                  <div className="text-sm text-slate-600 dark:text-white/60">{item.label}</div>
                  <div className="text-slate-900 dark:text-white font-semibold mt-1">{item.desc}</div>
                </Card>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-[#f4f6fb] to-white dark:from-black dark:via-[#0b0f14] dark:to-black">
        <div className="container mx-auto max-w-6xl space-y-12">
          <div className="space-y-3 text-center">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-white/50">What matters</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white">Speed. Simplicity. Reliability.</h2>
            <p className="text-slate-600 dark:text-white/60 text-lg max-w-3xl mx-auto">
              No feature bloat. Just the three pillars that keep your events running without chaos.
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="rounded-2xl h-full w-full bg-white px-6 py-6 flex flex-col gap-4 dark:bg-black/80">
                  ...
                  <p className="text-slate-600 dark:text-white/65 leading-relaxed flex-1">{item.desc}</p>
                </div>
              </Card>
            ))}
          </div>
      ...
      <section className="relative py-16 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative">
          <Card className="rounded-3xl border-slate-200 bg-white backdrop-blur-xl p-10 sm:p-12 text-center space-y-6 shadow-xl dark:border-white/10 dark:bg-white/5">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white">Free forever for simple events.</h2>
            <p className="text-slate-600 dark:text-white/65 text-lg max-w-2xl mx-auto">
              Upgrade only if you need more. Start now, share a link in seconds, and keep your players, students, and members in sync.
            </p>
      ...
      <footer className="border-t border-slate-200 py-10 px-4 sm:px-6 lg:px-8 bg-white/80 backdrop-blur dark:border-white/10 dark:bg-black/60">
        <div className="container mx-auto max-w-6xl flex flex-col sm:flex-row justify-between gap-6 sm:items-center text-slate-700 dark:text-white/70">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-slate-900 dark:text-white">SignUpPRO</div>
              <div className="text-xs text-slate-500 dark:text-white/50">Precision signup sheets for fast-moving organizers.</div>
            </div>
          </div>
          <div className="flex flex-wrap gap-4 text-sm">
            <Link href="/sign-in" className="hover:text-slate-900 dark:hover:text-white">Create Signup</Link>
